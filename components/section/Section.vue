<template>
  <section
    class="w-full h-[calc(100dvh-80px)] flex flex-col section"
    v-bind="$attrs"
  >
...
@media (min-width: 640px) {
  .outlined-text {
    text-shadow: 2px 2px 0 hsl(var(--accent)), -2px 2px 0 hsl(var(--accent)),
      -2px -2px 0 hsl(var(--accent)), 2px -2px 0 hsl(var(--accent));
  }
}
</style>
